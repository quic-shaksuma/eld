...
to \_\_aeabi\* functions and are not defined by the users.
...
Linker defines a variable \_\_start\_\<section> and \_\_stop\_\<section> if the linker
...
trampoline_for\_\<target symbol name>\_from\_\<source input section name>\_\<Input file
...
**Format:** trampoline_for\_\<target symbol name>\_from\_\<source input section name>
...
**Format:** trampoline_for\_\<target symbol name>\_from\_\<source input section name>\_
...
**Format:** trampoline_for\_\<target symbol name>\_from\_\<source input section name>\_#(relocation addend)
...
with the ELF flag SHF_GNU_RETAIN using '\_\_attribute\_\_((retain))'.
...
to '\_\_wrap_symbol', and all undefined references to '\_\_real_symbol' is resolved
...
:::{note}
extern void someSymbol_relocated (void) \_\_attribute\_\_((\_\_visibility\_\_("hidden")));

\_\_asm(".set someSymbol_relocated, 0x00005730");
:::
...
The programmer would have specified a *\_\_attribute\_\_((weak))* while declaring the function in the header file.

Also look at Weakreferencesanddefinitions why the linker was not seeing the definition.

:::{note}
A common work around for this sort of problem is to remove the \_\_attribute\_\_((weak)) from the prototype of the function.
:::
