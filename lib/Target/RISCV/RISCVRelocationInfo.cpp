...
#undef CUSTOM_RELOC_ENTRY
    ...
    {eld::ELF::riscv::internal::R_RISCV_TBJAL,
     {/*.Name = */ "R_RISCV_TBJAL",
      ...
      /*.Signed = */ false,
      /*.Size = */ 16}},
    {eld::ELF::riscv::internal::R_RISCV_QC_ABS26_I,
     {/*.Name = */ "R_RISCV_QC_ABS26_I",
      /*.Type = */ eld::ELF::riscv::internal::R_RISCV_QC_ABS26_I,
      /*EncodingType = */ EncTy_QC_EI,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
      /*.VerifyAlignment = */ false,
      /*.Signed = */ true,
      /*.Size = */ 48}},
    {eld::ELF::riscv::internal::R_RISCV_QC_ABS26_S,
     {/*.Name = */ "R_RISCV_QC_ABS26_S",
      /*.Type = */ eld::ELF::riscv::internal::R_RISCV_QC_ABS26_S,
      /*EncodingType = */ EncTy_QC_ES,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
      /*.VerifyAlignment = */ false,
      /*.Signed = */ true,
      /*.Size = */ 48}},
    {eld::ELF::riscv::internal::R_RISCV_QC_GPREL26_I,
     {/*.Name = */ "R_RISCV_QC_GPREL26_I",
      /*.Type = */ eld::ELF::riscv::internal::R_RISCV_QC_GPREL26_I,
      /*EncodingType = */ EncTy_QC_EI,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
      ...
      /*.Signed = */ true,
      /*.Size = */ 48}},
    {eld::ELF::riscv::internal::R_RISCV_QC_GPREL26_S,
     {/*.Name = */ "R_RISCV_QC_GPREL26_S",
      /*.Type = */ eld::ELF::riscv::internal::R_RISCV_QC_GPREL26_S,
      /*EncodingType = */ EncTy_QC_ES,
      /*.Alignment = */ 0,
      /*.shift = */ 0,
      /*.VerifyRange = */ false,
